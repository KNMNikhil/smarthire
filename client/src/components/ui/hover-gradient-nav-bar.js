...
const menuItems = [
  ...
  { icon: <MessageSquare className="h-5 w-5" />, label: "Chats", href: "/admin/chats", gradient: "radial-gradient(circle, rgba(147,51,234,0.4) 0%, rgba(126,34,206,0.2) 50%, rgba(88,28,135,0) 100%)" },
  { icon: <History className="h-5 w-5" />, label: "History", href: "/admin/history", gradient: "radial-gradient(circle, rgba(147,51,234,0.4) 0%, rgba(126,34,206,0.2) 50%, rgba(88,28,135,0) 100%)" },
  { icon: <User className="h-5 w-5" />, label: "Profile", href: "/admin/profile", gradient: "radial-gradient(circle, rgba(147,51,234,0.4) 0%, rgba(126,34,206,0.2) 50%, rgba(88,28,135,0) 100%)" },
];
...
function HoverGradientNavBar({ user, handleLogout }) {
