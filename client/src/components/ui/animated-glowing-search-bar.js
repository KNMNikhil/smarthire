  ...
  return (
    <div className="relative flex items-center justify-center">
      ...
      <div id="poda" className="relative flex items-center justify-center group">
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[70px] max-w-[314px] rounded-xl blur-[2px] 
                        before:absolute before:content-[''] before:z-[-2] before:w-[999px] before:h-[999px] before:bg-no-repeat before:top-1/2 before:left-1/2 before:-translate-x-1/2 before:-translate-y-1/2 before:rotate-60
                        before:bg-[conic-gradient(#000,#8b5cf6_5%,#000_38%,#000_50%,#ec4899_60%,#000_87%)] before:brightness-200 before:transition-all before:duration-[6000ms] before:ease-in-out
                        group-hover:before:rotate-[-60deg] group-focus-within:before:rotate-[420deg] group-focus-within:before:duration-[4000ms]">
        </div>
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[65px] max-w-[312px] rounded-xl blur-[2px] 
                        before:absolute before:content-[''] before:z-[-2] before:w-[600px] before:h-[600px] before:bg-no-repeat before:top-1/2 before:left-1/2 before:-translate-x-1/2 before:-translate-y-1/2 before:rotate-[82deg]
                        before:bg-[conic-gradient(rgba(0,0,0,0),#7c3aed,rgba(0,0,0,0)_10%,rgba(0,0,0,0)_50%,#db2777,rgba(0,0,0,0)_60%)] before:brightness-200 before:transition-all before:duration-[6000ms] before:ease-in-out
                        group-hover:before:rotate-[-40deg] group-focus-within:before:rotate-[442deg] group-focus-within:before:duration-[4000ms]">
        </div>
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[65px] max-w-[312px] rounded-xl blur-[2px] 
                        before:absolute before:content-[''] before:z-[-2] before:w-[600px] before:h-[600px] before:bg-no-repeat before:top-1/2 before:left-1/2 before:-translate-x-1/2 before:-translate-y-1/2 before:rotate-[82deg]
                        before:bg-[conic-gradient(rgba(0,0,0,0),#7c3aed,rgba(0,0,0,0)_10%,rgba(0,0,0,0)_50%,#db2777,rgba(0,0,0,0)_60%)] before:brightness-200 before:transition-all before:duration-[6000ms] before:ease-in-out
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[63px] max-w-[307px] rounded-lg blur-[1px] 
                        before:absolute before:content-[''] before:z-[-2] before:w-[600px] before:h-[600px] before:bg-no-repeat before:top-1/2 before:left-1/2 before:-translate-x-1/2 before:-translate-y-1/2 before:rotate-[83deg]
                        before:bg-[conic-gradient(rgba(0,0,0,0)_0%,#a855f7,rgba(0,0,0,0)_8%,rgba(0,0,0,0)_50%,#f472b6,rgba(0,0,0,0)_58%)] before:brightness-250
                        before:transition-all before:duration-[6000ms] before:ease-in-out group-hover:before:rotate-[-35deg] group-focus-within:before:rotate-[443deg] group-focus-within:before:duration-[4000ms]">
        </div>
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[59px] max-w-[303px] rounded-xl blur-[0.5px] 
                        ...
                        before:bg-[conic-gradient(#1c191c,#8b5cf6_5%,#1c191c_14%,#1c191c_50%,#ec4899_60%,#1c191c_64%)] before:brightness-200
                        before:transition-all before:duration-[6000ms] before:ease-in-out group-hover:before:rotate-[-50deg] group-focus-within:before:rotate-[430deg] group-focus-within:before:duration-[4000ms]">
        </div>
